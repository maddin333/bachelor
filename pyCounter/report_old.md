...
#### C:\Users\marti\Documents\gambio_tickets75\includes\classes\Smarty_2.6.14\plugins\outputfilter.trimwhitespace.php
* pregEval
 * Line 42: `    $source = preg_replace("!<pre>.*?</pre>!is",`
 * Line 47: `    $source = preg_replace("!<textarea[^>]+>.*?</textarea>!is",`
...
* pregEval
 * Line 95: `          $form.= '<input name="'.preg_replace('/PROCESSING.REDIRECT.PARAMETER./', '', $k).'" value="'.utf8_encode($v).'" type="hidden">';`
* deprecatedFunctions
...
* pregEval
 * Line 1057: `        $encoded = preg_replace('/([\000-\010\013\014\016-\037\075\177-\377])/e',`
 * Line 1060: `        $encoded = preg_replace("/([\011\040])".$this->LE."/e",`
 * Line 1076: `            $encoded = preg_replace("/([^A-Za-z0-9!*+\/ -])/e", "'='.sprintf('%02X', ord('\\1'))", $encoded);`
 * Line 1079: `            $encoded = preg_replace("/([\(\)\"])/e", "'='.sprintf('%02X', ord('\\1'))", $encoded);`
 * Line 1083: `            $encoded = preg_replace('/([\000-\011\013\014\016-\037\075\077\137\177-\377])/e',`
...
#### C:\Users\marti\Documents\gambio_tickets75\includes\modules\product_landingpage.php
* pregEval
 * Line 33: `$backLink = preg_replace('\/Landingpage\/.*/','',$currentUrl);`
 * Line 181: `        $landingpageLink = preg_replace('/Filter\/.*/','',$currentUrl);`
...
* pregEval
 * Line 696: `        $query   = preg_replace('/\s+ORDER\s+BY\s+([^\)]*)/', '', $query); //Remove ORDER BY from $query`
 * Line 711: `        $orderBy        = preg_replace('/ORDER\s+BY\s+([^\)]*)(.*)/', '$1', $orderBy);`
...
#### C:\Users\marti\Documents\gambio_tickets75\library\Zend\Service\Rackspace\Abstract.php
* pregEval
 * Line 378: `                $storageUrl = preg_replace('|(.*)://([^/]*)(.*)|', '$1://snet-$2$3', $storageUrl);`
...
#### C:\Users\marti\Documents\gambio_tickets75\mapa_callback.php
* pregEval
 * Line 16: `  $orderID = (int)preg_replace('/User.*Order(\d*)/', '$1', $TID);`
 * Line 17: `  $customerID = (int)preg_replace('/User(\d*).*/', '$1', $TID);`
...
* pregEval
 * Line 151: `                $svgMap = preg_replace('/<style.*?<\/style>/', '', $svgMap);`
