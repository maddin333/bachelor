...
\section{Entwicklung der an die neue Umgebung angepassten Software}
    ...
    Wie in Kapitel~\ref{php5magicquotes} ausgeführt, haben Aufrufe von \textit{magic\_quotes\_runtime} sowie \textit{set\_magic\_quotes\_runtime} seit \ac{PHP} 5.4 
    ...
    Da sich bei der Verwendung der Funktion \textit{list}, wie in Kapitel~\ref{php5listChanges} beschrieben, Änderungen ergeben haben, muss jeder Aufruf der 
    Funktion geprüft werden. Die Überprüfung im vorliegenden Fall ergab keinen Handlungsbedarf, da %TODO 
