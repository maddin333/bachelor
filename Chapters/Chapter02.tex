...
über die Gründe dieser zu treffen.
...
Wechsel der Ausführungsumgebung zwingend vorrausgesetzt.
    ...
    \subsection{Interpretation indirekter Variablenzugriffe}
    ...
    \subsection{Switch-Anweisungen mit mehreren default-Blöcken}
...
\section{Fazit}
Die Weiterentwicklung von \acs{PHP} steht 